# Endless Darkness — Chapters TODO

This file tracks chapter-level drafting progress. Each chapter entry is designed so a fresh LLM session can pick it up and write/revise that chapter in isolation.

- `[ ]` = not yet assembled as a continuous chapter
- `[~]` = rough chapter assembly done, needs smoothing / revision
- `[x]` = chapter draft in good shape (line edits only)

For each chapter:
- **Act / Part**: placement in the five-act structure and proposed Part.
- **Scenes**: source files in `docs/scenes/` to draw from.
- **POV / Tense**: recommended narrative lens (default: close third, past tense, primarily Jonah unless noted).
- **Focus**: emotional / thematic goals; what must be on the page.
- **Notes for LLM**: constraints and reminders for tone, canon, and continuity.
...
- Focus: Opening image of the generation ship; Jonah and Alina in the viewport niche; sense of endless dark and confinement; introduction of Tau Ceti mission myth and shipboard faith as background hum.
...
- POV / Tense: Close third on Jonah (child), past tense.
- Focus: Lived-in sense of working-sector family life; Ruth’s hull prayer as formative ritual; Lydia’s depression and the pivotal moment where Jonah freezes and walks away instead of helping.
...
- Focus: Behavioral stability mediation; Jonah’s inner life turned into data; early distrust of AI logging. Counterpoint with Samuel in the hull corridors as quiet steadiness and faith-in-maintenance.
...
- POV / Tense: Close third on Jonah, past tense.
- Focus: Clinical early AI evaluation where Jonah feels the machine looking *through* him. End Act I with his choice toward competence, invisibility, and distance.
- Notes for LLM: Lean into sensory detail of the test environment. The AI is not malevolent, but its gaze feels inescapable.
...
- Focus: Jonah and Sera’s first real shared shift; soft, humid counterpoint of hydroponics; early shared language about how they each hear ship noise; first corridor power flicker as subtle crack in Jonah’s stability.
...
- Focus: Alina’s experience of the ship’s scale and mood; diagnostic theatre mirroring Jonah’s earlier tests; explicit HALE/MARLOW comparator; siblings agreeing to watch each other and the ship for “weirdness.”
...
- POV / Tense: Close third on Jonah, past tense.
- Focus: Pre-evaluation family dinner combining faith, expectation, and quiet dread; subsequent training evaluation where Jonah’s competence and the ship’s “routine” psychological monitoring are both foregrounded.
...
- POV / Tense: Close third on Jonah, past tense.
- Focus: Integrated evaluation where the network demonstrates how thoroughly it knows him, calling him asset and risk. This is the bridge into the unraveling.
- Notes for LLM: Make the AI’s language precise and unnerving, but not evil. Jonah recognizes himself in the model and hates it.
...
- POV / Tense: Close third on Jonah, past tense.
- Focus: Later-life sermon echoing the Act I sermon, but with older Jonah’s skepticism and engineer-brain questions. Opens Part III with faith language undercut by unraveling trust in the AI.
...
- Focus: Companion routing Jonah to gardens as “behavioral health optimization”; Sera’s perception of this; coworkers’ gossip about Jonah’s status and the ship “babysitting” them.
...
- Focus: First real argument; Sera names her limits; Jonah recognizing Lydia-patterns in himself; Sera insisting she cannot be his only wall and nudging him toward broader support.
...
- Focus: Lydia reconstructed as dataset; Jonah/Alina overlaid; explanation (for the reader) of why the AI tightens the net now.
...
- Focus: Jonah discovering his pre-critical status and scheduled session; AI explicitly weighing thresholds between autonomy and safety; the choice to keep interventions soft while lowering emergency thresholds.
- Notes for LLM: Make the word “pre-critical” land hard on Jonah. Tie back emotionally to Lydia and forward to the Garden Incident.
...
- Focus: On-page episode in G-3 (oscillation, unauthorized override, cascading failure); injuries and emergency response; civilian panic and rumor.
...
- Focus: Jonah watching footage of his episode; Samuel refusing to leave him alone; fuller story of Lydia; insistence that Jonah is more than his indices.
...
- Focus: Hallway human cost outside the deactivation review; committee reducing Jonah to risk variables; Samuel and Sera’s testimony as stabilizing factors.
...
- Focus: Core aggregating footage, Lydia-model projections, public impact metrics, Samuel/Sera testimony; acknowledging threshold miscalculations; updating its loss function to include relational harm.
- Notes for LLM: Keep this as a clear mirror to Chapter 16 from the AI side. Calm, analytical, quietly terrified of repeating failure.
...
- Focus: Post-medbay ordinary day; medication routines; small teaching work; hydroponics visit; community bench scene showing cautious reintegration and acts of inclusion.
...
- Focus: Sera hearing a Core announcement quietly encoding Jonah’s case; her ritual of care in G-3; family pilgrimage to Lydia’s archives, rewriting the narrative of inheritance.
...
- POV / Tense: Close third on Jonah, past tense.
- Focus: Return to the childhood viewport niche; Ruth’s hull prayer spoken in a new key; Jonah feeling held as one small part of the ship’s forward motion.
- Notes for LLM: Quiet, restrained ending. No grand speeches. Let the dark stay endless, but no longer empty.
