# Scene: Companion Debates Thresholds on Jonah

## Context
- POV: AI-log, regional Companion
- Tense: past (logged present)
- Placement: Act III, after `companion-simulates-lydia-for-risk-modeling.md` and `late-night-node-precritical-pings.md`, before `garden-incident-live.md`
- Tone: clinical, introspective within machine limits; quietly ominous as it weighs intervention vs autonomy
