# Scene: Jonah's Early AI Aptitude Test

## Context
- Point of view: close third, Jonah
- Tense: past
- Placement: Act I – Formation, Jonah age 11–13, before formal AI Engineer training
- Intensity: Quiet, clinical; the external stakes are low, but internally this is Jonah’s first sense that the ship is looking *through* him

---

The testing center did not look important.

It hid three levels down from the school bands, buried in one of the administrative decks that smelled like filtered air and old cleaner. The hallways down here were too quiet. No kids running, no teachers calling anyone back, just the soft hiss of vents and the occasional hum of a lift door sealing.
...
The room beyond was small and soft in a way the rest of the deck wasn’t. Rounded corners. Cushioned bench along one wall. A single console table with a built-in display and interface field. No windows. Two Companion nodes: one in the ceiling above the table, one by the door.
...
Jonah’s name hanging in the air made the room feel tighter.
...
After a while the screen went blank. Jonah let his hands fall into his lap, fingers buzzing with the effort of not fidgeting.
...
Personal. His shoulders went tight at the word.
...
Text appeared beside each option: increased strain on backup systems, delay to agricultural lighting cycle, reduced power to non-essential entertainment grids.
...
Because if he knew all of it, he might look at me like he looks at her, Jonah thought. Because if anyone else knows how big it is, they might say it’s too big.
